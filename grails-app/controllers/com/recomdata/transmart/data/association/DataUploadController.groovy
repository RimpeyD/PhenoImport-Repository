...
class DataUploadController {
	...
	def dataUploadOut = 
	{
		...
		RModulesOutputRenderService.initializeAttributes(jobName,"DataUpload",imageLinks)
		...
		render(template: "/plugin/dataUpload_out", model:[imageLocations:imageLinks,zipLink:RModulesOutputRenderService.zipLink], contextPath:pluginContextPath)
/*		render(template: "/plugin/dataUpload_out", model:[], contextPath:pluginContextPath)*/
